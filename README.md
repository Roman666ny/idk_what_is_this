...
## Примечания
- Все алгоритмы реализованы на C++ и готовы к использованию
- Код содержит подробные комментарии для понимания работы
- Временная сложность указана в нотации Big O
- Для сортировок требуется передача массива по ссылке
- Для поисковых алгоритмов массив передается по константной ссылке
